FamousFramework.scene('svitlana:radio', {
    ...
    events: {
        ...
        '#radioLogo,#slider,#btn2,#flipBack,#radioTitle': {
    ...
    states: {
        ...
        programs: [
            '<iframe width="164" height="170" src="https://www.youtube.com/embed/JmSUefdxgY0" frameborder="0" allowfullscreen></iframe>',
            '<iframe width="164" height="170" src="https://www.youtube.com/embed/vecHZ0gBPX4" frameborder="0" allowfullscreen></iframe>',
            '<iframe width="164" height="170" src="https://www.youtube.com/embed/sTVWNMgoBZk" frameborder="0" allowfullscreen></iframe>'
        ],
        /*=size*/
        rootWidth: 230,
        rootHeight: 300,

FamousFramework.scene('svitlana:radio', {
    behaviors: {
        ...
        '#radioTitle': {
            'content': function () {
                //return '<div style=" margin-left:12px;margin-top:8px;text-color:white">Radio "OSA"</div>';
                return '<img width="140px" style="margin:12px" src="https://s3-us-west-2.amazonaws.com/svet.com/radio/logo-50.png"/>';
            },
        ...
        '#btn1': {
            ...
            'mount-point': [0.1, 0.5],
            'size': [60, 30],
            'style': function (accentColor, fsBtn) {
                return {
                    'font-size': fsBtn,
                    'color': accentColor,
                    'cursor': 'pointer',
        ...
        '#btn2': {
            ...
            'mount-point': [0.9, 0.5],
            'size': [150, 30],
            'style': function (primaryColor, fsBtn) {
                return {
                    'font-size': fsBtn,
                    'color': primaryColor,
                    'cursor': 'pointer',
        ...
        '#btn4': {
            ...
            'size': [64, 16],
            'style': function (accentColor100, fsBtn) {
                return {
                    'font-size': '12px',
                    'color': accentColor100,
                    'cursor': 'pointer',
